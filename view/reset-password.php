...
<section class="form-page">
    ...
    <form id="main-form" data-form-type="resetPassword" action="{{ langUrl('login/updatePassword') }}" method="post">
...
<!--         <button type="submit">Update Password</button> -->
        <div class="form-btns">
            <button class="save" type="submit" data-status="resetPassword" data-button-type="save">
